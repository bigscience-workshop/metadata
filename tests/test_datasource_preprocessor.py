...
class TestDatasourcePreprocessor(unittest.TestCase):
    def test_extract_datasource(self):
        ...
        target_metadata = [
            [{"key": "length", "type": "global", "value": "seattlejob.us > finance internships miami html"}],
            [{"key": "length", "type": "global", "value": "hawkeyesports.com > news > on time and on budget"}],
            [{"key": "length", "type": "global", "value": "www.plumberscrib.com > steam generators html"}],
        ]
        ...
        self.assertEqual(ds[:]["url"], target_text)
